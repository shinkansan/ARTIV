...
> 공기의 비열 : 0.24 kcal/kgC   
> 공기의 질량 : 1.2 kg/m^3   
> 트렁크 공간 내부의 질량 : 0.41 kg   
> 트렁크 공간 내부의 열용량 : 0.0984 kcal/C   
> IPC가 1시간 작동하는 동안 트렁크 공간 내부의 온도 변화 : 3049-5224 C ~~꺄악~~

물론... 이거보단 당연히 온도변화가 적을 것이다.   
트렁크의 공간을 실제보다 작게 근사하기도 했고, 우리의 차량은 고립계가 아니고,   
무엇보다 차량 내부의 표면도 엄연한 열용량이 존재한다.   
그러나 공간이 더 커봤자 3~4배 가랑 될것이고,   
...
그동안 자꾸 안되는 이유는, AutoDesk가 그동안 CFD에 학생 라이센스를 넣는 것을 깜빡한거 같다는 것이다. ~~무엇;~~   
