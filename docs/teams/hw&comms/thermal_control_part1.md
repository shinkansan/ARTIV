...
근데 일반적으로 고성능 컴퓨터의 오버클럭을 600W 라고 말하던데...   
...
> 공기의 비열 : 0.24 kcal/kgºC   
> 공기의 질량 : 1.2 kg/m<sup>3</sup>   
> 트렁크 공간 내부의 질량 : 0.41 kg   
> 트렁크 공간 내부의 열용량 : 0.0984 kcal/ºC   
> IPC가 1시간 작동하는 동안 트렁크 공간 내부의 온도 변화 : **3049-5224 ºC** ~~꺄악~~
...
고립계는 아니다 하더라도 일반적인 주행시 공기의 흐름은 제한되고,   
차량 내부의 표면은 그 온도가 충분히 올라가고 나서는 열평형 상태에 도달할 것이다...   
그리고 **IPC의 허용 온도는  60 ºC 이다.** ~~IPC:죽...여..줘...~~   
...
그래도 해보고 싶은 사람이 있다면 아래 링크에서 CFD 설치법을 참고하면 되겠다.

이후 포스팅 : [차량 내부 온도조절하기 part2](./thermal_control_part2.md)   
참고 : [Autodesk CFD 설치](./CFD_install.md)
